...
PKG_SOURCE_VERSION:=1e7f19813341dc3a6af7abd96f6f3b0e7bc216d6
PKG_MIRROR_HASH:=f764c2b475473bca071507f53310d1457956e33ee59dfb2721e2fa268800ecbf
...
define Build/Compile/smartdns-ui
	...
	+$(CARGO_PKG_VARS) CARGO_BUILD_ARGS="$(CARGO_BUILD_ARGS)" CC=$(shell echo $(TARGET_CC) | sed 's/^ccache //') \
